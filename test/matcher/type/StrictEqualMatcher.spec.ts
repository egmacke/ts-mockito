...
describe("StrictEqualMatcher", () => {
  describe("checking if string representation of number matches with number", () => {
    it("returns false", () => {
      // given
      const testObj: Matcher = strictEqual("5") as unknown as Matcher;
  ...
  describe("checking if false matches with zero", () => {
    it("returns false", () => {
      // given
      const testObj: Matcher = strictEqual(false) as unknown as Matcher;
  ...
  describe("checking if true matches with one", () => {
    it("returns false", () => {
      // given
      const testObj: Matcher = strictEqual(true) as unknown as Matcher;
